package com.venture.nexuschat.generator;
...
/**
 * mybatisPlus代码生成器
 * Created by daiwen on 2022/6/20
 */
public class MysqlGenerator {
    ...
    //需要生成的表 自定义
    //    private static final String[] includeTable = new String[]{"quota_info","quota_detail","quota_value_history"};
    private static final String[] includeTable         = new String[] { "user"};
    //包名
    private static final String   PACKAGE_NAME         = "com.venture.nexuschat";
    //模块名称
    ...
    private static final String   XML_PATH             = "mapper";

    /**
     * 通常，每个公司都有自己的表定义，在《阿里巴巴Java开发手册》中，
     * 就强制规定表必备三字段：id, gmt_create, gmt_modified。
     * 所以通常我们都会写个公共的拦截器去实现自动填充比如创建时间和更新时间的，无需开发人员手动设置。
     */
    //自定义实体，公共字段
    private static final String[] SUPER_ENTITY_COLUMNS = new String[] { "user_id" };
    //代码输出文件的路径
//    private static final String OUT_PATH = "C:\\Users\\hp\\Desktop\\code";
    private static final String OUT_PATH = "C:\\Users\\14553\\Desktop\\code";

    //    private static final String OUT_PATH = "D:\\temp\\code";
//    private static final String   OUT_PATH             = "c:\\develop\\code";
    //代码生成者
    private static final String   AUTHOR               = "zhp";
    ...
    private static final String   DRIVER               = "com.mysql.cj.jdbc.Driver";
    private static final String   URL                  = "jdbc:mysql://192.168.0.102:8082/mallchat?useUnicode=true&characterEncoding=utf-8&connectTimeout=5000&socketTimeout=5000&useSSL=false&serverTimezone=GMT%2B8";
    private static final String   USER_NAME            = "root";
    private static final String   PASSWORD             = "Yeainima521#";
    ...
    public static void main(String[] args) {
            ...
            .setTypeConvert(new MySqlTypeConvert() {
                ...
                public IColumnType processTypeConvert(GlobalConfig globalConfig, String fieldType) {
                    ...
                    if (fieldType.toLowerCase().contains("tinyint")) {
                        System.out
                            .println(String.format("%s -> %s", fieldType, DbColumnType.INTEGER));
                        return DbColumnType.INTEGER;
                    }
                    if (fieldType.toUpperCase().contains("datetime")) {
                        System.out
                            .println(String.format("%s -> %s", fieldType, DbColumnType.DATE_SQL));
        ...
        config.setOutputDir(OUT_PATH)// 输出目录
            ...
            .setMapperName("%sMapper") // 自定义dao文件命名，注意 %s 会自动填充表实体属性！
        ...
        // 代码生成器
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(config)//全局配置
